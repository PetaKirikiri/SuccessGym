...
- The shared coach renderer and roster are `public/owner-demo/coaches/cards.js`; styling is `cards.css`. There are 14 coaches. Bia, Bert and Tong have two photos. Boon uses only his former bottom photo (`coach-boon-2.jpg`) at the top; all other coaches have one photo.
